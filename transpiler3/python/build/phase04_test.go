...
// TestPhase4Records iterates every *.mochi file under
// tests/transpiler3/python/fixtures/phase04-records and runs
// runPythonFixture against the matching .out file.
func TestPhase4Records(t *testing.T) {
	fixtureDir := filepath.Join(repoRootForBuild(t), "tests", "transpiler3", "python", "fixtures", "phase04-records")
