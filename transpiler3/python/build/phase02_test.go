...
// TestPhase2Scalars iterates every *.mochi file under
// tests/transpiler3/python/fixtures/phase02-scalars and runs
// runPythonFixture against the matching .out file.
func TestPhase2Scalars(t *testing.T) {
	fixtureDir := filepath.Join(repoRootForBuild(t), "tests", "transpiler3", "python", "fixtures", "phase02-scalars")
